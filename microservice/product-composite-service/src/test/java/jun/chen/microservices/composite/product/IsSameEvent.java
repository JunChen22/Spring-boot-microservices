...
public class IsSameEvent extends TypeSafeMatcher<String> {
    ...
    private Map convertObjectToMap(Object objects) {
        JsonNode node = mapper.convertValue(objects, JsonNode.class);
        return mapper.convertValue(node, Map.class);
    }

    private String convertObjectToJsonString(Object objects) {
        try {
